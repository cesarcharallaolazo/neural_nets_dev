...
def _train(args):
    ...
    for epoch in range(0, args.epochs):
        ...
        for i, data in enumerate(train_loader):
            ...
            # print(i)
            # print(inputs)
            # torch.save(inputs, f'./train_sample/{i}_th_cifar_train_batch.pt')
...
# #         experiment_id='latest', inputs=input_object)
# #     return prediction
#
# def predict_fn(input_object, model):
...
#     # res = [{"status": "ok", "pred_cifar": str(prediction)}]
#     res = [{"status": "ok", "pred_cifar": pred.tolist()}]
#     print(res)
